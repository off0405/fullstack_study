...
const hap = document.querySelector('.box');
console.log(hap.textContent);
...
console.log(sps);
sps.forEach(function (apple) {
  apple.classList.add('hello');
});

// => forEach 함수 값으로 들어갈 배열 이름 새로 지어주기 apple
...
const hasActive = sps.classList.contains('acitve');
if (hasActive) {
  console.log('포함됨!');
} else {
  console.log('포함 안됨!');
