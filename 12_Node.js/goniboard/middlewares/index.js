...
// 로그인 중이면 req.isAuthenticated()(<-패스포트가 만들어주는 메소드) 가 true이고, 그렇지 않으면 false
...
const isNotLoggedIn = (req, res, next) => {
  if (!req.isAuthenticated()) {
    ...
    const message = encodeURIComponent('로그인한 상태입니다.') // 한글을 넣어줘야하니까 인코딩 시켜줨
...
module.exports = {
  isLoggedIn, isNotLoggedIn, checkIdAndPw
}